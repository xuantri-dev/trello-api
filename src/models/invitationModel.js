...
const INVITATION_COLLECTION__SCHEMA = Joi.object({
...
const validateBeforeCreate = async (data) => {
  return await INVITATION_COLLECTION__SCHEMA.validateAsync(data, { abortEarly: false })
}
...
// query tổng hợp (aggregate) để những bản ghi invitation thuộc về 1 thằng user cụ thể
